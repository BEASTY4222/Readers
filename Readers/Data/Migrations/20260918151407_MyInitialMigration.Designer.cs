...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Readers.Data.DataModels.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Readers.Data.DataModels.Like", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Readers.Data.DataModels.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Readers.Data.DataModels.Comment", b =>
                {
                    ...
                    b.HasOne("Readers.Data.DataModels.ApplicationUser", "User")
                        .WithMany("Comments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
